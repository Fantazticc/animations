	wait(5)
	local ver = "2.00"
	local scriptname = "FE Animations"
	local Frame = (60)
...
notifSound:Destroy()
game.StarterGui:SetCore("SendNotification", {Title = "FE Animations", Text = "animations loaded successfully!", Icon = "rbxassetid://505845268", Duration = 5, Button1 = "Okay"})
